...
## Features
- Modern and creative layout
- Consistent branding across pages
- User-friendly navigation
- Mobile-first responsive design

## Preview
Screenshots of each page can be found in the `/design` folder.

## Tools Used
- Figma

## Next Steps
This project will be developed into a real website using modern web technologies.
